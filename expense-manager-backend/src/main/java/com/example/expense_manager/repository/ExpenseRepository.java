 ...
 * This interface provides methods to perform CRUD operations and additional
 * query methods on Expense entities.
 ...
 * - {@link #findAllByDateBetween(LocalDate, LocalDate)}: Retrieves a list of
 * expenses within a date range.
 * - {@link #findByTitleContainingIgnoreCase(String)}: Retrieves a list of
 * expenses with titles containing the specified string, case insensitive.
 */
